...
public class LoopREPL {
	...
	public LoopREPL(Connection connection, String pk, String sk) throws InvalidKeyException, DataLengthException, SignatureException, InvalidKeySpecException, NoSuchAlgorithmException, IOException, DecoderException, CryptoException {
	...
	public void oneIteration() throws IOException, DecoderException, InvalidKeyException, DataLengthException, SignatureException, InvalidKeySpecException, NoSuchAlgorithmException, CryptoException {
		int tag = getTag();
